...
PrintErrorMessage = function() {
  ...
  cat("\ttiming segments are created by splitting the log2 ratios into 4 quartiles:\n")
  cat("\t\t1) upper (early replication)\n")
  cat("\t\t2) mid-upper (mid-early replication)\n")
  cat("\t\t3) mid-lower (mid-late replication)\n")
  cat("\t\t4) lower (late replication)\n")
